...
namespace WeaponDataExtractorTestsProject
{
    public class WeaponDataExtractorTests
    {
        ...
        public class FakeConstructibleObject { public object CreatedObject { get; set; } = new FakeFormKey(); public string EditorID { get; set; } = string.Empty; public FakeFormKey? FormKey { get; set; } }
